Create a structure Point3D to hold a 3D-coordinate {X, Y, Z} in the Euclidian 3D space. Implement the 
...
Create a class Path to hold a sequence of points in the 3D space. Create a static class PathStorage with static 
...
Write a generic class GenericList<T> that keeps a list of elements of some parametric
 ...
 the list, finding element by its value and ToString(). Check all input parameters to avoid 
