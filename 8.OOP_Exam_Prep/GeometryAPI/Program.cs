...
namespace GeometryAPI
{
                ...
                case "cylinder":
                    {
                        ...
                        currentFigure = new Cylinder(centerBottom,centerTop, radius);
                        break;
                    }
                ...
                case "normal":
                    {
                        ...
                        {
                            Console.WriteLine("{0:0.00}",(this.currentFigure as IFlat).GetNormal().ToString());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
    ...
    public class Circle : Figure, IFlat, IAreaMeasurable, ITransformable
    {    
    ...
    public class Cylinder : Figure,IVolumeMeasurable,IAreaMeasurable
    {
        ...
        public Cylinder(Vector3D top, Vector3D bottom, double radius)
            :base(top,bottom)
        {            
            this.height = (this.Top - this.Bottom).Magnitude;
            this.Radius = radius;
        }
        ...
        public double GetArea()
        {
            double bottomArea = this.Radius * this.Radius * Math.PI;
            double bottomPerimeter = this.Radius * 2 * Math.PI;

            double topAndBottomArea = bottomArea * 2;
            double sideArea = bottomPerimeter * this.height;
